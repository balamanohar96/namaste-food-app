export const RESTAURANTS_API = `https://tasteats.jainnaman1699.workers.dev/?apiUrl=${encodeURIComponent(
  "https://www.swiggy.com/dapi/restaurants/list/v5?lat=16.3200138&lng=80.4097937&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"
)}`;
...
export const MENU_API = `https://tasteats.jainnaman1699.workers.dev/?apiUrl=${encodeURIComponent(
  `https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=16.3200138&lng=80.4097937&restaurantId=`
)}`;
